...
int main()
{
	...
	// Used https://en.cppreference.com/w/cpp/memory/unique_ptr for educational purpose
	...
	std::unique_ptr<AmphibiousVehicle> ampVehicle(new AmphibiousVehicle("Hydra Spyder", 200.0));
	...
	if (status != Vehicle::Err_Status::Err_Success)
		cout << "The " << ampVehicle->GetName() << " automobile cannot travel 200km." << endl;
	cout << endl;
	...
	if (status != Vehicle::Err_Status::Err_Success)
		cout << "The " << ampVehicle->GetName() << " boat cannot travel 20km." << endl;
	cout << endl;
	...
	if (status != Vehicle::Err_Status::Err_Success)
		cout << "The " << ampVehicle->GetName() << " boat cannot add 30L of fuel." << endl;
	cout << endl;
	cout << "The boat will travel 200km" << endl;
	ampVehicle->Travel(200.0);
	if (status != Vehicle::Err_Status::Err_Success)
		cout << "The " << ampVehicle->GetName() << " boat cannot travel 200km." << endl;
	cout << endl;
	...
	status = ampVehicle->AddFuel(30);
	if (status != Vehicle::Err_Status::Err_Success)
		cout << "The " << ampVehicle->GetName() << " automobile cannot add 30L of fuel." << endl;
	cout << endl;
	cout << "The automobile will travel 300km" << endl;
	status = ampVehicle->Travel(300.0);
	if (status != Vehicle::Err_Status::Err_Success)
		cout << "The " << ampVehicle->GetName() << " automobile cannot travel 300km." << endl;
	cout << endl;
