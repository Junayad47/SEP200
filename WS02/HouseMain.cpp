...
int main()
{
	...
	if (house3 == house4)
		cout << "Houses 3 and 4 are the same" << endl;
	if (house3 == house5)
		cout << "Houses 3 and 5 are the same" << endl;
	if (house3 == house6)
		cout << "Houses 3 and 6 are the same" << endl;
	if (house4 == house5)
		cout << "Houses 4 and 5 are the same" << endl;
	if (house4 == house6)
		cout << "Houses 4 and 6 are the same" << endl;
	if (house5 == house6)
		cout << "Houses 5 and 6 are the same" << endl;
